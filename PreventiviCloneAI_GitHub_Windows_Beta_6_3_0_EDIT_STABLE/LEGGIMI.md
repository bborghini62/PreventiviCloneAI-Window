# Preventivi Clone AI Desktop 1.0 Beta 6.3.0 — Importazione ibrida veloce
...
## Beta 6.3.0 — correzioni definitive modifica/calcolo
- Le modifiche a quantità, prezzo, sconto e Calcola non ricreano più la tabella: focus e posizione restano sulla riga corrente.
- Ogni riga con Calcola attivo è indipendente: una sottovoce non sostituisce più il totale della voce principale.
- Il totale generale somma tutte le righe con Calcola attivo; per usare una voce principale come sola intestazione riepilogativa basta disattivare Calcola sulla voce principale.
